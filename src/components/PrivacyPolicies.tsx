...
function PrivacyPolicies() {
  return (
    <VStack>
      <Image src={logo} boxSize={200}></Image>
      <Text padding={10}>
        <strong>Privacy Policy</strong>{" "}
        <p>
          Mohamed Amine Bellil built the IZR app as a Free app. This SERVICE is
          provided by Mohamed Amine Bellil at no cost and is intended for use as
          is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which are accessible at IZR unless otherwise
        ...
        <p>
          ...
          but not limited to medaminbl. The information that I request will be
        ...
        <div>
          ...
          <ul>
            <li style={{ marginLeft: 50, color: "green" }}>
              <a
        ...
        <ul>
          <li style={{ marginLeft: 50 }}>To facilitate our Service;</li>{" "}
        ...
        <p>
          ...
          not hesitate to contact me at mbellil262@gmail.com.
        </p>{" "}
        <p>
